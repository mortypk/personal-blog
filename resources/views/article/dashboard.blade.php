                ...
                <div class="border-b border-gray-200 bg-white p-6">
                    ...
                    <div class="w-full rounded-md bg-white p-8">
                        <div class="flex items-center justify-between pb-2">
                            <div>
                                <h2 class="font-semibold text-gray-600">Articles</h2>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <div class="ml-3 space-x-2">
                                    <a href="{{ route('article.create') }}" class="cursor-pointer rounded-md bg-blue-600 px-4 py-2 font-semibold tracking-wide text-white">Create</a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="overflow-x-auton -mx-4 sm:-mx-8 sm:px-8">
                                <div class="inline-block min-w-full overflow-hidden rounded-lg shadow">
                                    <table class="min-w-full leading-normal">
                                        <thead>
                                            <tr>
                                                <th class="border-b-2 border-gray-200 bg-gray-100 p-2 text-left text-sm font-bold tracking-wider text-gray-600">Title</th>
                                                <th class="border-b-2 border-gray-200 bg-gray-100 p-2 text-left text-sm font-bold tracking-wider text-gray-600">Text</th>
                                                ...
                                                <th class="border-b-2 border-gray-200 bg-gray-100 p-2 text-left text-sm font-bold tracking-wider text-gray-600">Category</th>
                                                <th class="border-b-2 border-gray-200 bg-gray-100 p-2 text-left text-sm font-bold tracking-wider text-gray-600">Publish</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($articles as $article)
                                                ...
                                                <td class="flex border-b border-gray-200 bg-white p-1 text-sm">
                                                    <a href="{{ route('article.edit', $article->id) }}" class="text-blue-600">
