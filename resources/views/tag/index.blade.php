                ...
                <div class="border-b border-gray-200 bg-white p-6">
                    <div class="w-full rounded-md bg-white p-8">
                        <div class="flex items-center justify-between pb-2">
                            <div>
                                <h2 class="font-semibold text-gray-600">Tag</h2>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <div class="ml-3 space-x-2">
                                    <a href="{{ route('tag.create') }}" class="cursor-pointer rounded-md bg-blue-600 px-4 py-2 font-semibold tracking-wide text-white">Create</a>
                                </div>
                            </div>
                        </div>
                        <div>
                                            ...
                                            @foreach ($tags as $tag)
                                                <tr>
                                                    ...
                                                    <td class="flex border-b border-gray-200 bg-white p-1 text-sm">
                                                        <a href="{{ route('tag.edit', $tag->id) }}" class="text-blue-600">
